...
<div class="w-full max-w-2xl mx-auto px-4 lg:px-0">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
        ...
        <form action="{{ route('dashboard.users.update', $user) }}"
              method="POST"
              class="p-6 space-y-6">
            @csrf
            @method('PUT')
            <div>
                ...
                <input type="text"
                       ...
                       class="w-full border rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-700 focus:border-transparent transition-all {{ $errors->has('name') ? 'border-red-500 focus:ring-red-500' : 'border-gray-300' }}" required>
                @error('name')
            ...
            <div>
                ...
                <div class="relative">
                    <input type="password"
                           ...
                           class="w-full border rounded-lg px-3 py-2 pr-10 focus:ring-2 focus:border-transparent transition-all {{ $errors->has('password') ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-blue-700' }}">
                    <button type="button"
                            id="togglePassword"
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-yellow-700 mt-1">
                                Anda sedang mengedit akun Anda sendiri. Pastikan tidak mengubah role atau password tanpa sengaja.
                            </p>
                        </div>
                    </div>
                </div>
